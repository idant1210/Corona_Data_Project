...
y = day_count['new cases']
del day_count['new cases']
X_train, X_test, y_train, y_test = train_test_split(day_count, y, test_size = 0.3 , random_state = 41)
...
classification_model_minmax = logistic_reg.fit(X_train_scaled_minmax,y_train)
classification_model_standard = logistic_reg.fit(X_train_scaled_standard,y_train)
print(classification_model_standard)
